...
ENV VISU_SEMGREP_CI_URL="https://github.com/Ahddry/sast-visu-tools/releases/download/0.3.0/visu-semgrep-ci"
ENV SEMGREP_CUSTOM_URL="https://github.com/Ahddry/sast-visu-tools/releases/download/0.3.0/semgrep-custom"
